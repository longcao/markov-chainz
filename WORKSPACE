...
# then bind these repositories to alises in the //external package.
maven_dependencies()

# Load build_external_workspace from the 3rdparty/target_file.bzl file generated by bazel-deps
load("//3rdparty:target_file.bzl", "build_external_workspace")

# Put bound external deps under a synthetic @third_party_jvm external repository.
# The BUILD files for targets in @third_party_jvm are generated when the below macro is called.
